 ...
 */
public class CloudMatchUniversalViewHorizontal extends CloudMatchAcrossViewHorizontal {

    public CloudMatchUniversalViewHorizontal(final Context context) {
        super(context);
        mCriteria = Criteria.universal;
    }

    public CloudMatchUniversalViewHorizontal(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        mCriteria = Criteria.universal;
    }
}
