 ...
 * @author @ticofab
 */
public class CloudMatchPinchViewAllSides extends CloudMatchAcrossView4Sides {

    public CloudMatchPinchViewAllSides(final Context context) {
        super(context);
        mCriteria = Criteria.pinch;
    }

    public CloudMatchPinchViewAllSides(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        mCriteria = Criteria.pinch;
    }
}
